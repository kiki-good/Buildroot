...
$(STAGING_DIR)/$(AUTOMAKE_TARGET_BINARY): $(AUTOMAKE_DIR)/$(AUTOMAKE_BINARY)
	$(MAKE) \
...
automake: uclibc autoconf $(TARGET_DIR)/$(AUTOMAKE_TARGET_BINARY) $(STAGING_DIR)/$(AUTOMAKE_TARGET_BINARY)

automake-clean:
	$(MAKE) DESTDIR=$(TARGET_DIR) -C $(AUTOMAKE_DIR) uninstall
	$(MAKE) DESTDIR=$(STAGING_DIR) -C $(AUTOMAKE_DIR) uninstall
