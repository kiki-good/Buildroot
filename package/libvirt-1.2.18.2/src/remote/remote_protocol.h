...
#define REMOTE_DOMAIN_FUSE_MOUNTOPTIONS_MAX 256
...
struct remote_domain_mount_fuse_fs_args {
        ...
        remote_nonnull_string mountpoint;
        struct {
                u_int mountoptions_len;
                remote_nonnull_string *mountoptions_val;
        } mountoptions;
};
typedef struct remote_domain_mount_fuse_fs_args remote_domain_mount_fuse_fs_args;
...
extern  bool_t xdr_remote_domain_mount_fuse_fs_args (XDR *, remote_domain_mount_fuse_fs_args*);
...
extern bool_t xdr_remote_domain_mount_fuse_fs_args ();
