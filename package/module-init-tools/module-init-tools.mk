...
ifneq ($(BR2_ARCH_IS_64),y)
	...
	toolchain/patch-kernel.sh $(MODULE_INIT_TOOLS_DIR) package/module-init-tools/64bitPatch module-init-tools-$(MODULE_INIT_TOOLS_VERSION)\*.patch
endif
ifneq ($(BR2_ARCH_IS_64),y)
...
$(MODULE_INIT_TOOLS_DIR)/$(MODULE_INIT_TOOLS_BINARY): $(MODULE_INIT_TOOLS_DIR)/.configured
	$(MAKE) CC=$(TARGET_CC) -C $(MODULE_INIT_TOOLS_DIR) CFLAGS="-DCONFIG_NO_BACKWARDS_COMPAT"
...
ifneq ($(BR2_ARCH_IS_64),y)
	...
	toolchain/patch-kernel.sh $(MODULE_INIT_TOOLS_DIR2) package/module-init-tools/64bitPatch module-init-tools-$(MODULE_INIT_TOOLS_VERSION)\*.patch
endif
ifneq ($(BR2_ARCH_IS_64),y)
...
$(MODULE_INIT_TOOLS_DIR2)/$(MODULE_INIT_TOOLS_BINARY): $(MODULE_INIT_TOOLS_DIR2)/.configured
	$(MAKE) -C $(MODULE_INIT_TOOLS_DIR2) CFLAGS="-DCONFIG_NO_BACKWARDS_COMPAT"
