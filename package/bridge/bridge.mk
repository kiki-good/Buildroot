...
BRIDGE_CONF_OPT:=--with-linux-headers=$(LINUX_HEADERS_DIR) $(DISABLE_NLS) --prefix=/ --exec-prefix=/
...
$(BRIDGE_POST_INSTALL_HOOKS): $(BRIDGE_TARGET_INSTALL_TARGET)
	$(STRIPCMD) $(STRIP_STRIP_ALL) $(TARGET_DIR)/sbin/brctl
	touch $@
endif
...
$(BRIDGE_TARGET_UNINSTALL):
	...
	rm -f $(BRIDGE_TARGET_INSTALL_TARGET) $(BRIDGE_POST_INSTALL_HOOKS)
