...
$(USBUTILS_DIR)/.unpacked: $(DL_DIR)/$(USBUTILS_SOURCE)
	...
	toolchain/patch-kernel.sh $(USBUTILS_DIR) package/usbutils/ usbutils-$(USBUTILS_VERSION)-\*.patch
...
$(TARGET_DIR)/$(USBUTILS_TARGET_BINARY): $(USBUTILS_DIR)/$(USBUTILS_BINARY)
	...
	cp $(USBUTILS_DIR)/usbutils.pc $(STAGING_DIR)/usr/lib/pkgconfig/
	rm -rf $(TARGET_DIR)/usr/man

usbutils: zlib libusb $(TARGET_DIR)/$(USBUTILS_TARGET_BINARY)
